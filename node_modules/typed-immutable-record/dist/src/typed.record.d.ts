 ...
 */
export interface TypedRecord<T extends TypedRecord<T>> extends Map<string, any> {
    ...
    merge: (obj: any) => T;
    mergeWith: (merger: (previous?: any, next?: any, key?: string) => any, obj: any) => T;
    mergeDeep: (obj: any) => T;
    mergeDeepWith: (merger: (previous?: any, next?: any, key?: string) => any, obj: any) => T;
